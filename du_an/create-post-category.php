<?php require_once("inc/lib.php"); 
	if($_SERVER["REQUEST_METHOD"]=="POST"){
			...
			$sql="INSERT INTO category_posts(title,content,cat_id)
...
<html>
<head>
	<title>Tạo Chuyên Mục Bài Viết</title>
	<meta charset="utf-8"/>
...
<body>
	<div id="website">
		...
		<div id="main-content">
			<div id="main-left">
				<div id="list"><i i class="fa fa-plus"></i> Tạo Chuyên Mục Bài Viết</div>
